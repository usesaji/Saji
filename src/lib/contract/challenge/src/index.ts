...
export const networks = {
  testnet: {
    ...
    contractId: "CCOVZRUF5SOFVF26G4PKTESVTOXJ3IB6LAVHLEZTSBS3E6OEDHR7Q5JD",
  }
} as const
 ...
 */
export type DataKey = {tag: "Token", values: readonly [u64]} | {tag: "Balance", values: readonly [u64, string]};
...
export interface Client {
   ...
   * deposit. Read-only.
   */
  token_of: ({challenge_id}: {challenge_id: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Option<string>>>
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "AAAAAAAAAFVUaGUgdG9rZW4gYSBjaGFsbGVuZ2UgaXMgZGVub21pbmF0ZWQgaW4sIG9yIE5vbmUgYmVmb3JlIGl0cyBmaXJzdApkZXBvc2l0LiBSZWFkLW9ubHkuAAAAAAAACHRva2VuX29mAAAAAQAAAAAAAAAMY2hhbGxlbmdlX2lkAAAABgAAAAEAAAPoAAAAEw==",
        ...
        "",
