        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            render={
              <button
                type="button"
                className="absolute top-2 right-2 flex size-8 items-center justify-center rounded-full text-muted-foreground hover:bg-black/5"
              />
            }
          >
            <XIcon />
      ...
      {showCloseButton && (
        <DialogPrimitive.Close
          render={
            <button
              type="button"
              className="h-10 rounded-md border border-input px-4 text-sm font-medium hover:bg-black/5"
            />
          }
        >
          Close
