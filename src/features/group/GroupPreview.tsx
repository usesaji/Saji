	...
	return (
		<div className="mt-4 md:mt-6">
			...
			<section className="mt-5">
				...
				<Button variant="secondary" className="mt-5 md:mt-7">
					Join Group
				</Button>
			</section>
		</div>
...
// 	return (
// 		<div className="mt-4 md:mt-6">
// 			<h2 className="text-xl md:text-3xl">Summer Fund</h2>

// 			<div className="rounded-2xl overflow-hidden h-36 mt-3 md:h-48 lg:h-52">
// 				<Image
// 					alt="Group Profile Picture"
// 					src="/images/group-test-img.png"
// 					width={800}
// 					height={800}
// 					className="h-full w-full object-cover"
// 				/>
...
// 				<div className="bg-[#f7f7f7] rounded-2xl p-4 md:flex-1 md:p-6">
// 					<h5 className="text-xs font-light md:text-sm">12 Members</h5>
// 					<div className="h-10 mt-2 md:h-14">
// 						<img src="/images/review-user-imgs.png" className="h-full" alt="" />
// 					</div>
// 				</div>
// 			</section>
...
// 							</p>
// 						</div>
// 						<div className="text-sm md:text-base font-medium">Rotating</div>
// 					</div>
// 					{/*  */}
// 					<div className="flex justify-between items-center border-b border-b-[#d9d9d9] pb-2">
// 						<div className="flex items-center gap-1 md:gap-2">
...
// 							</p>
// 						</div>
// 						<div className="text-sm md:text-base font-medium">Randomized</div>
// 					</div>
// 					{/*  */}
// 					<div className="flex justify-between items-center border-b border-b-[#d9d9d9] pb-2">
// 						<div className="flex items-center gap-1 md:gap-2">
...
// 							</p>
// 						</div>
// 						<div className="text-sm md:text-base font-medium">Monthly</div>
// 					</div>
// 					{/*  */}
// 					<div className="flex justify-between items-center pb-2">
// 						<div className="flex items-center gap-1 md:gap-2">
...
// 						added members will also be notified to confirm their addition.
// 					</p>
// 					<div className="h-10 mt-4 md:h-14 md:mt-6">
// 						<img src="/images/review-user-imgs.png" className="h-full" alt="" />
// 					</div>
